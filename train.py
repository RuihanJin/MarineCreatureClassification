...
def train():
    ...
    train_dataset = MarineCreatureDataset(image_dir=opt.image_dir, image_size=opt.image_size, mode='train')
    valid_dataset = MarineCreatureDataset(image_dir=opt.image_dir, image_size=opt.image_size, mode='valid')
